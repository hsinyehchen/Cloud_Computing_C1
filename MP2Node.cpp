...
void MP2Node::updateRing() {
     ...
     */
    // Run stabilization protocol if the hash table size is greater than zero and if there has been a changed in the ring. Here we only consider node removal.
...
void MP2Node::clientCreate(string key, string value) {
    ...
    g_transID++; // increase trans id
    mpMsgRec[g_transID] = KY_RPY(0, CREATE, key, value); // add message into record
...
void MP2Node::clientRead(string key){
    ...
    mpMsgRec[g_transID] = KY_RPY(0, READ, key, ""); // add message into record
...
void MP2Node::clientUpdate(string key, string value){
    ...
    mpMsgRec[g_transID] = KY_RPY(0, UPDATE, key, value);// add message into record
...
void MP2Node::clientDelete(string key){
    ...
    mpMsgRec[g_transID] = KY_RPY(0, DELETE, key, "");// add message into record
